...
const Portfolio: React.FC = () => {
  ...
  const projects: ProjectData[] = [
    ...
    },
    {
      ...
      url: 'https://sire-school.vercel.app/'
    },
    {
      ...
      url: 'https://sire-netflix.vercel.app/'
    }
  ];
    ...
    <div id='portfolio' className="py-20 flex flex-col items-center justify-center relative">
      ...
      <div className="flex items-center justify-center w-full max-w-6xl relative">
        <button
          ...
          className="absolute left-4 z-10 bg-black/50 hover:bg-black/70 text-white p-3 rounded-full transition-all duration-300 backdrop-blur-sm cursor-pointer"
        ...
        <button
          ...
          className="absolute right-4 z-10 bg-black/50 hover:bg-black/70 text-white p-3 rounded-full transition-all duration-300 backdrop-blur-sm cursor-pointer"
          onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}
